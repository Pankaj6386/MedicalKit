...
const CustomTable = ({
  ...
  console.log(surName, "userDatas))))", userDatas?.user_details);
  ...
  console.log(newArray, "---userDatas--11-", userDatas?.user_details);
  ...
  const handleSelect = (item) => {
    console.log("setSelectedLocation handleRole----", item);
  ...
  return (
    <View style={styles.table}>
      ...
      {type === "Dashboard"
            ...
            return (
              <View
                ...
                <View
                  ...
                  <Text style={styles.cellText}>{x.name}</Text>
                </View>
                <View
                  style={[
                    styles.cell,
                  ...
                  <Text style={styles.cellText}>{x.incidents}</Text>
                </View>
                <View
                  style={[
                    styles.cell,
        ...
        ? rowsData?.map((x, i) => {
            let assigned_role;
            console.log("----assigned_role---", x.user_status);
...
// import { addAdminUserId } from "../redux/reducer/auth";
// import { call_get_UserInfo } from "../redux/action/AdminAction";
// const CustomTable = ({
//   columns,
//   rowsData,
//   type,
...
//   const dispatch = useDispatch();
//   const [keepUpdateModal, setKeepUpdateModal] = useState(false);
//   const [editUserItem, setEditUserItem] = useState(false);
//   const [editUserItemId, setEditUserItemId] = useState(null);
...
//         : type === "manageUsers"
//         ? rowsData?.map((x, i) => {
//             console.log(rowsData, "------teble body----", x);
//             let assigned_role;
//             switch (x.assigned_role) {
//               case "salesrepresentative":
//                 assigned_role = "Sales Representative";
...
//                 <TouchableOpacity
//                   onPress={() => {
//                     // dispatch(addAdminUserId(x?._id));
//                     dispatch(call_get_UserInfo(x?._id))
//                       .then((res) => {
//                         console.log(res.payload);
//                         if (res.payload.status === 200) {
//                           // setSwicthScreens("EDIT_REGISTER_USER");
//                           setEditUserItem(!editUserItem);
//                           setEditUserItemId(x?._id);
//                         }
//                       })
//                       .catch((err) => {
