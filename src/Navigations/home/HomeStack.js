...
const HomeStack = () => {
  return (
    <Stack.Navigator
      ...
      />
      <Stack.Screen
        name={navigationString.scanBarcodeScreen}
        component={Screens.ScanBarcodeScreen}
      />

      <Stack.Screen
        name={navigationString.NewsAndUpdateScreen}
        component={Screens.newsAndUpdateScreen}
      />
    </Stack.Navigator>
  );
};
