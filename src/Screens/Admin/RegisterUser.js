...
import { call_AdminRegisterUser_API } from "../../redux/action/AdminAction";
...
const RegisterUser = ({
  ...
  const requestHandler = async () => {
    ...
    setSwitches({
      Incidents_Via_Email: role === "superadmin" ? true : false,
      Access_Incidents: role === "superadmin" ? true : false,
    });
    setSwitche({
      Share_Incidents: role === "superadmin" ? true : false,
      Access_Kits: role === "superadmin" ? true : false,
    });
  };
  ...
  // const [switches, setSwitches] = useState({
  //   Incidents_Via_Email:
  //     userDatas?.user?.data.role == "superadmin" ? true : false,
  //   Access_Incidents: userDatas?.user?.data.role == "superadmin" ? true : false,
  // });

  // const [switche, setSwitche] = useState({
  //   Share_Incidents: userDatas?.user?.data.role == "superadmin" ? true : false,
  //   Access_Kits: userDatas?.user?.data.role == "superadmin" ? true : false,
  // });
