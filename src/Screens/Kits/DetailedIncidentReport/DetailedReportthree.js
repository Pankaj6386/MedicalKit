...
const DetailedReportthree = ({ navigation, route }) => {
  ...
  const handleInjuryType = (item) => {
    console.log(item, "------handle injury");
    setInjuryType(item);
  ...
  const personOftreatment = () => {
    dispatch(call_PersonOftreatment_Api())
      .then((res) => {
        // console.log(
        //   "---personOftreatment--",
        //   JSON.stringify(res.payload?.data?.Users)
        // );
  ...
  // console.log(
  //   JSON.stringify(incidentCategoryDetails.data),
  //   "----presonIncidentList--",
  //   presonIncidentList
  // );
          ...
          <View
            ...
            <ScrollView
              ...
              {/* <CustomDropdown
                ...
                onSelect={handlePersontreatment}
              ...
              data={data}
              onSelect={handleIncidentOutcome}
            /> */}
              <InputFields
                placeholder="Incident Outcome"
                value={moreDetails}
